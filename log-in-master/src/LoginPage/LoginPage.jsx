...
const logo = "./src/img/hogwart.svg";
            ...
            <nav className="navbar navbar-dark navbar-expand-sm fixed-top">
                <div className="container">
                    ...
                    <a className="navbar-brand" href="#">
                        ...
                        <span>HỌC VIỆN PHÁP THUẬT HOGWART</span>
                    </a>
                    <div className="collapse navbar-collapse" id="Navbar">
                        <ul className="navbar-nav mr-auto">
                            <li className="nav-item active"><a className="nav-link" href="#"><span
                                className="fa fa-home fa-lg"></span> Trang chủ</a></li>
                            <li className="nav-item"><a className="nav-link" href="#"><span
                                className="fa fa-info fa-lg"></span> Giới thiệu</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
